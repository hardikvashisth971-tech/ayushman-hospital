import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, s as shimExports, a as cn, H as HOSPITAL_INFO, B as Button, L as Link, P as Phone, C as Clock, D as DOCTORS, b as DEPARTMENTS } from "./index-DKO4PK6f.js";
import { D as DepartmentIcon } from "./DepartmentIcon-94X-T7VI.js";
import { u as useCallbackRef, a as useLayoutEffect2 } from "./index-DPcGNP4Y.js";
import { P as Primitive } from "./index-PS5BhIdd.js";
...
const BedDouble = createLucideIcon("bed-double", __iconNode$4);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                backgroundImage: "url('/assets/generated/hero-doctors-team.dim_1400x700.jpg')"
              },
              "aria-hidden": "true"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "linear-gradient(105deg, oklch(0.13 0.07 210 / 0.92) 40%, oklch(0.2 0.08 195 / 0.6) 100%)"
              },
              "aria-hidden": "true"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid lg:grid-cols-2 gap-12 items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight", children: [
                    "Quality Healthcare",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block", style: { color: "oklch(0.82 0.12 175)" }, children: "for Every Life" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-white/80 max-w-lg leading-relaxed", children: "Compassionate care. Advanced medicine. Dedicated specialists — all under one roof. At Ayushman Hospital, your well-being is our highest calling." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4 pt-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/appointments", children: "Book Appointment" })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "a",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "shadow-elevated border-border/40 bg-card/95 backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 space-y-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-xl text-foreground", children: "Quick Appointment" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: FEATURED_DEPTS.map((dept) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Link,
                    {
                      to: "/appointments",
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-9 h-9 flex items-center justify-center rounded-full bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          DepartmentIcon,
                          {
                            name: dept.iconName,
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex-1 min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block font-medium text-foreground", children: dept.name }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-sm text-muted-foreground truncate", children: dept.description })
                        ] }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/appointments", children: "Schedule Now" })
                    }
                  )
                ] }) })
              }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "data-ocid": "home.stats_section", className: "bg-primary py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-6 text-center", children: STATS.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(s.icon, { className: "w-6 h-6 text-primary-foreground/80 mb-1" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-3xl font-bold text-primary-foreground", children: s.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-primary-foreground/75", children: s.label })
        ]
      },
      s.label
    )) }) }) }),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground", children: "World-Class Medical Departments" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-muted-foreground max-w-xl mx-auto", children: "From routine check-ups to complex interventions — every department is staffed by specialists dedicated to your care." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: FEATURED_DEPTS.map((dept, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { opacity: 0, y: 30 },
              whileInView: { opacity: 1, y: 0 },
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Card,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 flex flex-col gap-4 h-full", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-12 h-12 flex items-center justify-center rounded-xl bg-primary/10 group-hover:bg-primary/20 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      DepartmentIcon,
                      {
                        name: dept.iconName,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-lg text-foreground", children: dept.name }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1 leading-relaxed", children: dept.description })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1 flex-1", children: dept.keyTreatments.slice(0, 3).map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "li",
                      {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mt-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", children: "View All Departments" })
            }
          ) })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "data-ocid": "home.why_us_section", className: "bg-muted/30 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                variant: "outline",
                className: "text-primary border-primary/30 mb-3",
                children: "Why Ayushman"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground", children: "Healthcare You Can Trust" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-muted-foreground max-w-xl mx-auto", children: "We combine clinical excellence with genuine compassion to deliver outcomes that matter most to you and your family." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: FEATURES.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-card border-border h-full shadow-card hover:shadow-elevated transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 flex gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `w-12 h-12 flex-shrink-0 flex items-center justify-center rounded-xl ${f.bg}`,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(f.icon, { className: `w-6 h-6 ${f.color}` })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "data-ocid": "home.doctors_section", className: "bg-background py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-muted-foreground max-w-xl mx-auto", children: "A team of nationally recognised specialists committed to personalised, evidence-based care." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: DOCTORS.slice(0, 6).map((doc, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0, y: 25 },
          whileInView: { opacity: 1, y: 0 },
            ...
            Card,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 mb-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "w-14 h-14 border-2 border-primary/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-primary/10 text-primary font-semibold text-lg", children: doc.name.split(" ").filter((w) => w !== "Dr.").slice(0, 2).map((w) => w[0]).join("") }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground truncate", children: doc.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-primary font-medium truncate", children: doc.specialty }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: doc.qualification })
                  ] })
                ] }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/doctors/$id", params: { id: String(doc.id) }, children: "View Profile" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/appointments", children: "Book" })
                    }
                  )
                ] })
              ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mt-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          className: "border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-smooth",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/doctors", children: "Meet All Doctors" })
        }
      ) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground", children: "What Our Patients Say" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-muted-foreground max-w-xl mx-auto", children: "Real experiences from the people who trusted us with their health." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: TESTIMONIALS.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { opacity: 0, y: 30 },
              whileInView: { opacity: 1, y: 0 },
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-card border-border shadow-card h-full flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 flex flex-col gap-4 h-full", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-0.5", children: Array.from({ length: t.rating }).map((_, si) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Star,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 pt-2 border-t border-border", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "w-10 h-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-primary/10 text-primary font-semibold", children: t.name.split(" ").slice(0, 2).map((w) => w[0]).join("") }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "data-ocid": "home.cta_section", className: "bg-primary py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        className: "space-y-5",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-primary-foreground", children: "Book an Appointment Today" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-lg max-w-lg mx-auto", children: "Our specialists are ready to help you. Schedule your visit now and experience healthcare at its finest." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-center gap-4 pt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/appointments", children: "Book Now" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-primary-foreground/60 text-sm pt-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                children: HOSPITAL_INFO.emergencyPhone
              }
            )
          ] })
        ]
